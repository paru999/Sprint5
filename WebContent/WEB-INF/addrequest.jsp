...
<div class="row">
 <div class=" col-md-3">
 <img src= ${img} vertical-align= "left" width= "20%"> ${UserName} ${LastName}  
 <br>
 ...
 <a href="confirmrequest" >Apporve Friends</a>
  ...
  <div class=" col-md-4">
   <form:form name="search" method="Post" action="/spring2/add" modelAttribute="SearchBean " id="srchform" >
 ...
 <c:forEach var="tbl_user" items="${listUsers.rows}"> 
   ...
   <div class=" col-md-3">
	...
	<div class=" col-md-4">
	<a href="/spring2/add?id=<c:out value="${tbl_user.pk_int_UID}"/>" style="color:grey;"><span class="glyphicon glyphicon-user" style="color:grey;" ></span>
